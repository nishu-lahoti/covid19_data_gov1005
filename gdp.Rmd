...
jhu_confirmed_series <- read_csv("data_misc/GitHub/COVID-19/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_global.csv") %>% 
  clean_names()
...
total_daily_covid_deaths <- read_csv("data_misc/total-daily-covid-deaths.csv") %>%  
  clean_names()
