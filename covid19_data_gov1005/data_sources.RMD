...
covid_global_stock_tidied <- covid_global_stock %>% 
  pivot_longer(cols = -c("Country", "new_date", "confirmed", "deaths", "recovered"), names_to = "stock", values_to = "price")

saveRDS(covid_global_stock_tidied, file = "stock_data.RDS")
```
